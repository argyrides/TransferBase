...
namespace TransferBase
{
    public partial class MLModel2TransferSuccess
    {
       ...
       // private static string MLNetModelPath = Path.GetFullPath("MLModel2TransferSuccess.zip");
        private static string MLNetModelPath = @"C:\Users\alexa\source\repos\TransferBase\TransferBase\Model\MLModel2TransferSuccess.zip";
